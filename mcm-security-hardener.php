...
final class MCM_Security_Hardener {
	...
	public static function get_defaults() {
		return [
			...
			// WP_DEBUG beheer: 'keep' = wp-config.php bepaalt, 'off' = uit,
			// 'log' = aan maar alleen naar debug.log (nooit tonen aan bezoekers).
			'debug_mode'             => 'keep',
			...
			'noindex_login'               => true, // login-pagina uit Google houden (header + meta)
			...
			'php_error_warning_threshold_per_hour'       => 50,
			'php_error_post_upgrade_threshold_per_hour'  => 10,
